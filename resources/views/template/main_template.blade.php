            ...
            <div id="sidebar-menu">
                <ul>
                    ...
                    @if(Auth::user() != null && Auth::user()->isAdmin())
                        <li class="has_sub">
                            <a href="javascript:void(0);" class="waves-effect"><i class="zmdi zmdi-settings"></i>
                                <span> Manage Covid Data </span> <span class="menu-arrow"></span></a>
                            <ul class="list-unstyled">
                                <li><a href="{{ URL::route('get_covid_data_list') }}">Covid Data List</a></li>
                                <li><a href="{{ URL::route('create_covid_data') }}">Add Covid Data</a></li>
                            </ul>
                        </li>
                    @endif

                    <li class="has_sub">
                        <a href="{{ URL::route('get_api_list') }}" class="waves-effect"><i
                                class="zmdi zmdi-view-web"></i><span> API Doc </span> </a>
                    </li>
